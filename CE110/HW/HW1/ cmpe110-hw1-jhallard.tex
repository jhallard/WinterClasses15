...
\begin{tabular}{| l | c | c | c | c | c | c | c | c | c | c | c |} \hline
 ...
 Jump   &  1000 &   PC  &   \texttt{jmp \#1000          }  &      &     & 1000  &     &         &        &       &       \\ \hline
 \end{tabular}
 \end{center}
 \end {table}
...
\textbf{Explanation} : The answers to this problem are contained in the third rows of the two tables above. This Add instruction only increases the PC by a single instruction, so the PC is only increased by 4 bits. 
...
\textbf{Explanation} : The answers to this problem are contained in the fourth rows of the two tables above. 
